import {
    ...
    Locale, PermissionFlagsBits, PermissionsBitField
} from 'discord.js';
...
export async function slashCommandHandler(client: BotClient, interaction: ChatInputCommandInteraction, es: Embed, ls: Locale, GuildSettings: Settings): Promise<void> {
...
export async function checkCommand(client: BotClient, command: Command|ContextCommand, ctx: ChatInputCommandInteraction, es: Embed, ls: Locale, dontCheckCooldown?: boolean): Promise<boolean> {
...
export async function isOnCooldown(client: BotClient, command: Command|ContextCommand, ctx: CommandInteraction, es: Embed, ls: Locale): Promise<boolean> {

...
var chunk_BXUPHLWW_exports = {};
__export(chunk_BXUPHLWW_exports, {
  cleanupCache: () => cleanupCache
});
module.exports = __toCommonJS(chunk_BXUPHLWW_exports);
...
async function cleanupCache(n = 5) {
  try {
    const rootCacheDir = await (0, import_chunk_JLJWRMAC.getRootCacheDir)();
    if (!rootCacheDir) {

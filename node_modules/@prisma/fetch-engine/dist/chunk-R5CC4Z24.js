...
var chunk_R5CC4Z24_exports = {};
__export(chunk_R5CC4Z24_exports, {
  download: () => download,
...
module.exports = __toCommonJS(chunk_R5CC4Z24_exports);
var import_chunk_Q7UG36US = require("./chunk-Q7UG36US.js");
var import_chunk_QVKNF2OV = require("./chunk-QVKNF2OV.js");
var import_chunk_BXUPHLWW = require("./chunk-BXUPHLWW.js");
var import_chunk_FDMUWNGX = require("./chunk-FDMUWNGX.js");
var import_chunk_JLJWRMAC = require("./chunk-JLJWRMAC.js");
...
var require_stream = (0, import_chunk_VBXJIVYU.__commonJS)({
  "../../node_modules/.pnpm/execa@5.1.1/node_modules/execa/lib/stream.js"(exports, module2) {
    "use strict";
    var isStream = (0, import_chunk_FDMUWNGX.require_is_stream)();
...
var import_fs_extra = (0, import_chunk_VBXJIVYU.__toESM)((0, import_chunk_JLJWRMAC.require_lib)());
var import_p_filter = (0, import_chunk_VBXJIVYU.__toESM)(require_p_filter());
var import_temp_dir = (0, import_chunk_VBXJIVYU.__toESM)((0, import_chunk_FDMUWNGX.require_temp_dir)());
...
async function download(options) {
  ...
  if (binariesToDownload.length > 0) {
    const cleanupPromise = (0, import_chunk_BXUPHLWW.cleanupCache)();
    let finishBar;
    let setProgress;
    ...
    const promises = binariesToDownload.map((job) => {
      const downloadUrl = (0, import_chunk_JLJWRMAC.getDownloadUrl)({
        channel: "all_commits",
...
async function binaryNeedsToBeDownloaded(job, nativePlatform, version) {
  ...
  if (cachedFile) {
    if (job.skipCacheIntegrityCheck === true) {
      await (0, import_chunk_JLJWRMAC.overwriteFile)(cachedFile, job.targetFilePath);
      return false;
    }
...
async function getCachedBinaryPath({
  ...
  const cacheDir = await (0, import_chunk_JLJWRMAC.getCacheDir)(channel, version, binaryTarget);
  if (!cacheDir) {
    return null;
  }
...
async function downloadBinary(options2) {
  ...
  const { sha256, zippedSha256 } = await (0, import_chunk_FDMUWNGX.downloadZip)(downloadUrl, targetFilePath, progressCb);
  if (progressCb) {
    progressCb(1);
  }
...
async function saveFileToCache(job, version, sha256, zippedSha256) {
  const cacheDir = await (0, import_chunk_JLJWRMAC.getCacheDir)(channel, version, job.binaryTarget);
  if (!cacheDir) {
    return;
  }
  ...
  try {
    await (0, import_chunk_JLJWRMAC.overwriteFile)(job.targetFilePath, cachedTargetPath);
    if (sha256 != null) {

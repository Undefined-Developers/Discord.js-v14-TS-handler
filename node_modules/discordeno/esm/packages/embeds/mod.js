...
import { formatImageURL, iconBigintToHash } from "./deps.js";
...
function avatarURL(userId, discriminator, options) {
    return options?.avatar
        ? formatImageURL(routes.USER_AVATAR(userId, typeof options?.avatar === "string" ? options.avatar : iconBigintToHash(options?.avatar)), options?.size || 128, options?.format)
        : routes.USER_DEFAULT_AVATAR(Number(discriminator) % 5);
}
export class Embeds extends Array {

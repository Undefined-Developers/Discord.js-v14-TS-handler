...
exports.createGuildFromTemplate = void 0;
/**
 * Create a new guild based on a template
 * NOTE: This endpoint can be used only by bots in less than 10 guilds.
 */
async function createGuildFromTemplate(bot, templateCode, data) {
    if (data.icon) {
...
exports.createGuildFromTemplate = createGuildFromTemplate;

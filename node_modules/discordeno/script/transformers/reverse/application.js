...
exports.transformApplicationToDiscordApplication = void 0;
function transformApplicationToDiscordApplication(bot, payload) {
    return {
        name: payload.name,
...
exports.transformApplicationToDiscordApplication = transformApplicationToDiscordApplication;

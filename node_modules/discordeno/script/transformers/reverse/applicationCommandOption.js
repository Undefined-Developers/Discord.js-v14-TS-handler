...
exports.transformApplicationCommandOptionToDiscordApplicationCommandOption = void 0;
function transformApplicationCommandOptionToDiscordApplicationCommandOption(bot, payload) {
    return {
        type: payload.type,
        name: payload.name,
...
exports.transformApplicationCommandOptionToDiscordApplicationCommandOption = transformApplicationCommandOptionToDiscordApplicationCommandOption;

...
exports.transformAuditLogEntryToDiscordAuditLogEntry = void 0;
function transformAuditLogEntryToDiscordAuditLogEntry(bot, payload) {
    return {
        ...
        changes: payload.changes?.map((change) => {
            switch (change.key) {
                ...
                case "id":
                    return {
                        key: change.key,
                        old_value: change.old ? bot.transformers.reverse.snowflake(change.old) : "",
                        new_value: change.new ? bot.transformers.reverse.snowflake(change.new) : "",
                    };
                case "name":
                case "description":
...
exports.transformAuditLogEntryToDiscordAuditLogEntry = transformAuditLogEntryToDiscordAuditLogEntry;
